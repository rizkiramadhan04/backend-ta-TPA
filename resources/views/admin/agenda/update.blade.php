...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.agenda-update', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group col-xl-6 col-md-4">
                ...
                <input type="text" class="form-control @error('nama_produk') is-invalid @enderror" id="name_agenda"
                    aria-describedby="nama_agenda" name="nama_agenda" value="{{ $data->nama_agenda }}">
                @error('nama_agenda')
            ...
            <div class="form-group col-xl-6 col-md-4">
                ...
                <textarea type="text" class="form-control @error('deskripsi_agenda') is-invalid @enderror"
                    id="deskripsi_agenda" name="deskripsi_agenda" value="{{ $data->deskripsi_agenda }}">{{ $data->deskripsi_agenda }}</textarea>
            ...
            <div class="form-group col-xl-6 col-md-4">
                ...
                <input type="date" class="form-control @error('tanggal_agenda') is-invalid @enderror" id="tanggal_agenda"
                    name="tanggal_agenda" value="{{ $data->tanggal_agenda }}">
